...
def extract_names(text):
    ...
    pattern1 = r".n the (m|rn)a..er o. (.+?) [\{\(\[]App.ican. Tenan.(?:s|\(s\))?[\)\}\]](?: and )?(.+?) [\{\(\[]Responden. Land.ord(?:s|\(s\))?[\)\}\]]"
    pattern2 = r".n the (m|rn)a..er o. (.+?) [\{\(\[]App.ican. Land.ord(?:s|\(s\))?[\)\}\]](?: and )?(.+?) [\{\(\[]Responden. Tenan.(?:s|\(s\))?[\)\}\]]"
    pattern3 = r".n the (m|rn)a..er o. (.+?) [\{\(\[]App.ican./Responden. Tenan.(?:s|\(s\))?[\)\}\]](?: and )?(.+?) [\{\(\[]Responden./Applican. Land.ord(?:s|\(s\))?[\)\}\]]"
    pattern4 = r".n the (m|rn)a..er o. (.+?) [\{\(\[]Applican./Responden. Land.ord(?:s|\(s\))?[\)\}\]](?: and )?(.+?) [\{\(\[]Responden./Applican. Tenan.(?:s|\(s\))?[\)\}\]]"
    pattern5 = r".n the (m|rn)a..er o. (.+?) [\{\(\[]Tenan.(?:s|\(s\))?[\)\}\]](?: and )?(.+?) [\{\(\[]Land.ord(?:s|\(s\))?[\)\}\]]"
    pattern6 = r".n the (m|rn)a..er o. (.+?) [\{\(\[]Land.ord(?:s|\(s\))?[\)\}\]](?: and )?(.+?) [\{\(\[]Tenan.(?:s|\(s\))?[\)\}\]]"
    pattern7 = r".n the (m|rn)..er o. (.+?) [\{\(\[]Appe..an. Tenan.(?:s|\(s\))?[\)\}\]](?: and )?(.+?) [\{\(\[]Responden. Land.ord(?:s|\(s\))?[\)\}\]]"
    pattern8 = r".n the (m|rn)a..er o. (.+?) [\{\(\[]Appe..an. Land.ord(?:s|\(s\))?[\)\}\]](?: and )?(.+?) [\{\(\[]Responden. Tenan.(?:s|\(s\))?[\)\}\]]"
